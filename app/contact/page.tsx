  ...
  return (
    <div className="bg-gradient-to-tl from-zinc-900/0 via-zinc-900 to-zinc-900/0">
      ...
      <div className="container mx-auto min-h-screen px-4 flex items-center justify-center">
        <div
          className="
            mx-auto mt-32 sm:mt-0 w-full gap-8 lg:gap-12 grid
            ...
            <Card key={s.label}>
              ...
              >
                ...
                <div className="z-10 flex flex-col items-center text-center">
                  <span className="font-display font-medium text-zinc-200 group-hover:text-white duration-150 lg:text-xl xl:text-3xl">
                    {s.handle}
                  </span>
                  <span className="mt-4 text-sm text-zinc-400 group-hover:text-zinc-200 duration-1000">
                    {s.label}
                  </span>
                </div>
              </Link>
